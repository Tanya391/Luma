      ...
      <div className="mx-auto max-w-[1440px]">
        ...
        <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
          ...
          <div>
            ...
            <h2 className="max-w-5xl font-['Cormorant_Garamond'] text-5xl leading-[0.9] tracking-[-0.045em] sm:text-6xl md:text-7xl">
        ...
        {/* Principles */}
        <div className="mt-10 border-t border-[var(--luma-line)]">

          {principles.map((item) => (
            <div
              key={item.number}
              className="grid gap-5 border-b border-[var(--luma-line)] py-8 md:grid-cols-[80px_1fr_1fr] md:items-start md:py-10"
            >
              ...
              <h3 className="font-['Cormorant_Garamond'] text-3xl leading-none md:text-4xl">
                {item.title}
              </h3>
        ...
        <div className="mt-16 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          ...
          <p className="max-w-2xl font-['Cormorant_Garamond'] text-3xl leading-tight md:text-4xl">
